...
interface Electronic extends Item {
  brand?: string
  status?: string
}
...
export default function ElectronicsPage() {
  ...
  useEffect(() => {
    const fetchElectronics = async () => {
      try {
        setError(null)
        const data = await apiClient.getPopularItems("ELECTRONICS")
        setElectronics(data.items || [])
      } catch (error) {
        console.error("Failed to fetch electronics:", error)
        setError("Failed to load electronics. Please try again later.")
      } finally {
        setLoading(false)
      }
    }
    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <nav className="hidden md:flex items-center space-x-8">
                ...
                <Link href="/dashboard/electronics" className="text-red-600 font-medium flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Available Electronics</h1>
            <p className="text-gray-600">Browse and purchase electronics from our marketplace</p>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Error loading electronics</h3>
                ...
                <Card key={item._id} className="overflow-hidden hover:shadow-lg transition-shadow">
                  <div className="relative h-48">
                    ...
                    <div className="absolute top-4 right-4">
                          ...
                          className={`px-3 py-1 rounded-full text-sm font-medium ${
                            (item.status || "AVAILABLE") === "AVAILABLE" || (item.status || "ACTIVE") === "ACTIVE" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                          }`}
                        >
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="text-2xl font-bold text-red-600">Frw {item.price.toLocaleString()}</span>
                      </div>
          ...
          {!loading && electronics.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No electronics available</h3>
